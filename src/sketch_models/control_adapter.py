...
from .condition_encoder import SketchConditionEncoder


SKETCH_CONTROL_KEY = "sketch_encoded"


class SketchControlAdapter(nn.Module):
    """Encode one Canny sequence and project it into WAN's DiT width."""
    ...
    def __init__(
        ...
        *,
        ...
        self.control_key = SKETCH_CONTROL_KEY
        self.target_spatial = target_spatial
        self.use_gradient_checkpointing = use_gradient_checkpointing
        self.condition_encoder = SketchConditionEncoder(
    ...
    def get_modality_weights(self) -> dict[str, float]:
        return {
            "canny": float(torch.sigmoid(self.modality_gate).detach().cpu())
        }
