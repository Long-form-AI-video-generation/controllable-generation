...
class MultiVideoTrainer:
    ...
    def __init__(
        ...
        if torch.cuda.device_count() > 1:
            ...
            print("\n Only 1 GPU detected, running on single GPU")
            self.model = model
            self.base_model = model
    ...
    def train_step(self, batch):
        ...
        timesteps = torch.randint(0, 800, (batch_size,), device=self.device).long()
...
def main():
    ...
    try:
        ...
        print(f"  Saved interrupted checkpoint at epoch {epoch}")
        ...
        print(f"  Saved error checkpoint at epoch {epoch}")
